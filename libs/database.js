...
class DatabaseOperation
{
    static CreateTables()
    {
        ...
        {
            Database.run('create table if not exists Tag(ID_Tag INTEGER PRIMARY KEY AUTOINCREMENT, Name TEXT, Value TEXT, UNIQUE (Name, Value) ON CONFLICT REPLACE)', ErrorCallback)
